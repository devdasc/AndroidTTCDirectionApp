...
public class MessageActivity extends AppCompatActivity {
    ...
    private boolean hasReadSmsPermission() {
        return ContextCompat.checkSelfPermission(MessageActivity.this,
    ...
    private void requestReadAndSendSmsPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(MessageActivity.this, Manifest.permission.READ_SMS)) {
            //Log.d(TAG, "shouldShowRequestPermissionRationale(), no permission requested");
            return;
        }
        ActivityCompat.requestPermissions(MessageActivity.this, new String[]{Manifest.permission.READ_SMS, Manifest.permission.RECEIVE_SMS},
                SMS_PERMISSION_CODE);
    }
}
